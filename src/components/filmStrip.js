 ...
 function imageColumn(){
  ...
  function older(){
	...
	return (
		<>
		<p id="layout-toggle">
	       <svg id="image-toggle" className="on" onClick={imageColumn} width="45" height="50" viewBox="0 0 45 50" fill="none" xmlns="http://www.w3.org/2000/svg">
	        ...
	        <svg id="text-toggle" onClick={textColumn} width="40" height="50" viewBox="0 0 40 50" fill="none" xmlns="http://www.w3.org/2000/svg">
